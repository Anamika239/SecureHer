...
type ExploreScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Tabs'>;
...
export default function ExploreScreen() {
  ...
  return (
    <ImageBackground
      source={require('../../assets/women.jpg')} // Adjusted path to match your structure
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.taskContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => navigation.navigate('Tabs', { screen: 'sos' })}
          >
